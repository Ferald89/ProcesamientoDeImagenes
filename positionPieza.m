%% Programa Para detectar detección de elementos
...
%% Se Procede a la obtenci�n de valores
s = regionprops(IBW,'centroid','Orientation');%aqui logramos sacar el centroide de la figura y la orientación
...
hold off
%% Con el angulo podemos tomar una decisi�n
